...
<body>
  ...
  <p class="text-center Myfont" style="font-size:22px;" name="register">แก้ไขรหัสผ่าน</p>
    <div class="container col-sm-4 Myfont" style=" box-shadow:0px 0px 5px #000; padding:15px; border-radius: 10px;">
      <form action="UpdatePassAdmin.php" name="form1" method="post" enctype="multipart/form-data">
        <input  name="admin_ID" id="admin_ID" hidden  type="text" class="form-control "  value="<?php echo$row1['admin_ID'] ?>">
