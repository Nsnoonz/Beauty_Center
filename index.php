...
<script type="text/javascript">
  $(function() {
    ...
    <body class="Myfont">
      ...
      <?php
       $order = $_POST['order'];
        $sql3 = "SELECT * FROM clinic,service,servicetype WHERE (service_Price BETWEEN $min AND $max) AND clinic.clinic_ID=service.clinic_ID and clinic.Status= 1 and servicetype.serviceType_ID=service.serviceType_ID  ORDER By service.service_Price $order";
