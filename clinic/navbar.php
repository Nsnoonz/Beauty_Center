...
<nav class="navbar sticky-top  navbar-expand-lg navbar-dark bg-info Myfont">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link  text-light" href="AllService.php?clinic_ID=<?php echo  $_SESSION["clinic_ID"]; ?>&token=<?php echo md5( $_SESSION['clinic_ID'].'@Confirm'); ?>">บริการของคุณ</a>
      </li>
      <li class="nav-item">
        <a class="nav-link  text-light"  href="AllBooking.php?clinic_ID=<?php echo  $_SESSION["clinic_ID"]; ?>&token=<?php echo md5( $_SESSION['clinic_ID'].'@Confirm'); ?>">รายการจอง</a>
      </li>
      <li class="nav-item">
        <a class="nav-link  text-light" href="payment.php">ชำระค่าบริการ</a>
      </li>
      <li class="nav-item"></a>
      </li>
    </ul>
